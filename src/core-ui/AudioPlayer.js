...
import { setPlay, setPause, setPlayPause, volumeChange, loadTrack, toggleUnmount } from '../reducers/playerActions';
import player_play from '../assets/images/player_play.png';
import player_pause from '../assets/images/player_pause.png';
import player_prev from '../assets/images/player_prev.png';
import player_next from '../assets/images/player_next.png';
import Duration from './Duration'
import erstesSet from '../assets/sets/2022_02_09.mp3';
...
class AudioPlayer extends Component {
  ...
  load = url => {
    ...
    this.props.loadTrack({url, played: 0, loaded: 0, pip: false})
  }
  ...
  handleVolumeChange = e => {
    ...
    this.props.volumeChange(parseFloat(e.target.value));
  }
  ...
  render() {
    const { controls, light, loop, played, duration, playbackRate } = this.state;
    const { playing, url, volume, muted, loaded, pip, toggleUnmount } = this.props.player;
    const SEPARATOR = ' · ';
    const myUrl = "http://www.kl-testground.de/files/2022_02_09.mp3";
    return (
      <div>
        ...
        <ReactPlayer ref={this.ref}
              ...
              <input type="image" src={player_prev} className="prevButton" onClick={this.handlePlayPause} />
              <input type="image" src={playing ? player_pause : player_play} className="playButton" onClick={this.handlePlayPause} />
              <input type="image" src={player_next} className="prevButton" onClick={this.handlePlayPause} />
              {/* {this.renderLoadButton(myUrl, 'mp3')}
              <button onClick={this.toggleControls}>Controls</button> */}
              </section>
              <section className="playerSeekBar ">
              <p className="timeDisplay"><Duration seconds={duration * played} /></p>
              <input
                    ...
                    className="seekBar"
                  />
                  <p className="timeDisplay"><Duration seconds={duration} /></p>
                  </section>
                  
                  {/* <div style={{display: this.state.showControls === true ? "none" : ""}}>
          <section >
          <table>
            <tbody>
              <tr>
              ...
              <tr>
                <th>Volume</th>
                <td>
                  <input type='range' min={0} max={1} step='any' value={this.props.player.volume} onChange={this.handleVolumeChange} />
                </td>
              </tr>
              <tr>
                <th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {this.renderLoadButton('http://kl-testground.de/files/2022_02_09.mp3', 'mp3')}
                  <br />
...
export default connect(mapStateToProps, { setPlay, setPause, setPlayPause, volumeChange, loadTrack, toggleUnmount })(AudioPlayer);